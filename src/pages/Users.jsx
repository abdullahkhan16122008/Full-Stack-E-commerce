...
const Users = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.post('https://full-stack-e-commerce-gd4t.onrender.com/api/users');
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await axios.delete(`https://full-stack-e-commerce-gd4t.onrender.com/api/users/${id}`);
